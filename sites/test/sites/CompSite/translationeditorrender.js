define(['knockout', 'jquery'], function (ko, $) {
	...
	// ----------------------------------------------
	var sampleComponentTemplate = '<div style="width: 100%; text-align: center; margin-bottom: 20px; font-size:16px; font-weight:600;"><label id="translationeditorlabel">Translation Job Editor</label></div><div class="contentformdiv"><iframe id="editFrame" src="_devcs_component_translationeditor_edit_html_path" style="width: 100%; height: 500px; border-width: 0px;"></iframe></div>';
