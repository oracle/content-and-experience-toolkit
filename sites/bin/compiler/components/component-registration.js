			...
			'scs-dynamiclist': {
				'config': {
					...
					'properties': [
						...
						'language',
						'lastLabel',
						'layoutCategory', // dynamic list - this is the itemViewLayoutStyle setting
						'lazyLoadClickText',
						'linkType',
						'loadType',
						'marginBottom',
						...
						'visibleOnMobile',
						'width',
						'searchQueryString', //dynamic list
						'orderByString',     //dynamic list
						'fieldsString',      //dynamic list
						'emptyListViewString'//dynamic list
					],
					'transientProperties': [
						'appendOffset',
						'offset',
